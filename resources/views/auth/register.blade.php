                    ...
                    <div class="col-lg-6">
                        ...
                        @csrf
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="name" type="text" placeholder="Enter your name..." data-sb-validations="required" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus />
                            ...
                            <!-- Email address input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="email" type="email" placeholder="name@example.com" data-sb-validations="required,email" name="email" value="{{ old('email') }}" required autocomplete="email" />
                            ...
                            <div class="d-grid"><button class="btn btn-primary btn-xl "  type="submit">Register</button></div>
